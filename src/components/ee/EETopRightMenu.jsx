...
import EEWinConditions from "./EEWinConditions";
...
const EETopRightMenu = ({ expandedMenu, activeTab, selectTab }) => {
	...
	const menuItemsImgs = [
		...
		},
		{
			...
			iconInactive: populationInactive,
			iconActive: populationActive,
		},
		{
		...
		{
			key: "funding and taxes",
			iconInactive: fundingInactive,
			iconActive: fundingActive,
		},
	];
	...
	return (
		<div
			...
			style={{ width: 395, justifyContent: "space-evenly" }}
		>
			<Tippy
				singleton={source}
		...
		case "wildlife stats":
			return (
				<DynamicChart
					metric="wildlife"
					color="#82ca9d"
					title="Wildlife Population Over Time"
				/>
			);
		case "landscape stats":
			return (
		...
		case "win conditions":
			return (
				<EEWinConditions
					...
					satisfaction={satisfaction}
					connectionPercentage={connectionPercentage}
					conncetionTarget={connectionTarget}
				/>
			);
		case "population stats":
