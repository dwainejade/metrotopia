...
const LWLConstructionMenu = ({ onCancel }) => {
	const {
		tiles,
		neighboringCities,
		placeObject,
	...
	const { resources } = useLwlResourcesStore();
	...
	const calculateBuildingImpact = () => {
		...
		const buildingImpactOnLizards = (building) => {
			switch (building) {
		...
		return {
			...
			wildlifeDisplaced: Math.floor(
				mergedInfo.metrics.wildlife.reptilesAndAmphibians *
					buildingImpactOnLizards(selectedStructure.id)
			),
				...
				<>
					...
					<div className="impact-grid">
						...
						<div className="post-lizards-lwl">
							<p>Anole lizards</p>
							<p>{metrics.wildlife.reptilesAndAmphibians}</p>
						</div>
						<div className="post-lizards-lost-lwl">
							<p>Estimated anole lizards to be Lost</p>
			...
			return (
				<>
					...
					<div className="tile-grid">
						{metrics.wildlife && (
							<div className="wildlife-lwl">
								<p>Anole Lizards</p>
								<p>{metrics.wildlife.reptilesAndAmphibians}</p>
							</div>
						)}
						{metrics.treeCount !== undefined && (
							<div className="trees-lwl">
								<p>Trees</p>
								<p>{metrics.treeCount}</p>
							</div>
						)}
						{metrics.temperature !== undefined && (
							<div className="temp-item temp-lwl">
								<p>Surface Temp</p>
								<p>{metrics.temperature}°F</p>
							</div>
						)}
						<div className="temp-item water-lwl">
							<p>Surface Water</p>
...
export default LWLConstructionMenu;
