...
import WinConditionDetails from "./PPWinConditions";
...
import LandscapeDetails from "./PPLandscapeDetails";
...
const TopRightMenu = ({ expandedMenu, activeTab, selectTab }) => {
	...
	const menuItemsImgs = [
		...
		{
			key: "energy stats",
			iconInactive: energyInactive,
			iconActive: energyActive,
		},
		{
			key: "air pollution stats",
			iconInactive: pollutionInactive,
			iconActive: pollutionActive,
		},
	];
