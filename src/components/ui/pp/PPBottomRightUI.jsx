...
import '@src/styles/BottomRightUI.css';
import Tippy from '@tippyjs/react';
import AnimatedValue from '@src/helpers/AnimatedValue';

// icons
import populationIcon from '@src/assets/bottom-right/population.svg';
import natureIcon from '@src/assets/bottom-right/nature.svg';
import wildlifeIcon from '@src/assets/bottom-right/wildlife.svg';
import airIcon from '@src/assets/bottom-right/air.svg';
import thermometerIcon from '@src/assets/ess/upper-right-menu/thermometer-white.svg';
