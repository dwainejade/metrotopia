...
import gameObjects, { greenModMetrics } from '@src/data/gameObjects';
import { greenModCosts } from '@src/data/gameObjects';
  ...
  const handleGreenModToggle = (upgradeType, category) => {
    ...
    if (category === 'structuralUpgrades') {
      ...
      if (upgradeType === 'solarRoof') {
        ...
        if (
          !selectedTileData.upgrades.connectionMods.power?.includes('solar')
        ) {
          updatePreviewUpgrade('localPower', null);
        }
