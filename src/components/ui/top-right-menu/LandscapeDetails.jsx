            ...
            <div className="bottom-checklist nature">
                <div className="nature-stats">
                    <p>
                        ...
                        <span>
                            <AnimatedValue value={temperature?.starting || 0} precision={1} />
                            °F
                        </span>
                    </p>
                    <p>
                        ...
                        <span>
                            <AnimatedValue value={temperature?.current || 0} precision={1} />
                            °F
                        </span>
                    </p>
                    ...
                    <p>
                        ...
                        <span>
                            <AnimatedValue value={-72 + temperature?.starting || 0} precision={1} />
                            °F
                        </span>
                    </p>
                    <p>
                        ...
                        <span>
                            <AnimatedValue value={-72 + temperature.current} precision={1} />
                            °F
                        </span>
                    </p>
                </div>
