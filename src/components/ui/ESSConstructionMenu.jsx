...
import useGridStore from "../../stores/essGridStore";
import useAudioStore from "../../stores/audioStore";
import useResourcesStore from "../../stores/essResourcesStore";
import gameObjects, {
	transportationConnectionModifiers,
} from "../../data/gameObjects";
import "../../styles/ConstructionMenu.css";
import BuildingButton from "./BuildingButton";
import RoundedButton from "./RoundedButton";
import { collectModsForNewTile } from "../../helpers/propagateMods";
import {
	spaceEachWord,
	capitalizeEachWord,
...
import { getPopoverProps } from "../../helpers/getTooltipProps";

const ESSConstructionMenu = ({ onCancel }) => {
	const {
		tiles,
		neighboringCities,
		placeObject,
			...
			return (
				<>
					...
					<div className="impact-grid">
						...
						{availablePowerConnections.length === 1 ? (
							<div className="energy-source-note-item ess">
			...
			<div className="header-wrapper">
				<div className="header" style={{ width: getHeaderWidth() }}>
					...
					<div className="category-con">
						<button
							className={`residential-icon ${activeConstructionBuildingCategory === "residential"
								? "active"
								: ""
						...
						<button
							className={`commercial-icon ${activeConstructionBuildingCategory === "commercial"
								? "active"
								: ""
						...
						<button
							className={`services-icon ${activeConstructionBuildingCategory === "services"
								? "active"
								: ""
						...
						<button
							className={`industrial-icon ${activeConstructionBuildingCategory === "industrial"
								? "active"
								: ""
...
export default ESSConstructionMenu;
