...
import gameObjects, { greenModMetrics } from '@src/data/ppGameObjects';
import useStore from './ppGridStore';
...
const initialResourceState = {
  ...
  wildlife: {
    ...
    totalLost: 0,
    percentPreserved: 100,
    targetPreservation: 85, // target percent
...
const useMainResourcesStore = create(
  persist(
    ...
    {
      name: 'city-resources-policy-power',
