...
import useStore from './essGridStore';
...
const useEssResourcesStore = create(
  persist(
    (set, get) => ({
      ...
      updateCurrentTemperature: () => {
        ...
        const { resources } = useEssResourcesStore.getState();
    ...
    {
      name: 'city-resources-ess',
      storage: createJSONStorage(() => localStorage),
    }
  )
);

export default useEssResourcesStore;
