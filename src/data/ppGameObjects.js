...
const gameObjects = {
	...
	urbanStructures: {
		...
		governmentBuilding: {
			...
			buildingRestrictions: ["governmentBuilding", "factory", "warehouse", "retailCenter", "mediumOfficeBuildings", "tallOfficeBuilding", "hotels"],
		},
		hospital: {
			id: "hospital",
			name: "Hospital",
			...
			buildingRestrictions: ["hospital", "factory", "warehouse", "retailCenter", "mediumOfficeBuildings", "tallOfficeBuilding", "hotels"],
		},
		warehouse: {
			id: "warehouse",
			name: "Warehouse",
