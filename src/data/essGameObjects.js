...
export const greenModMetrics = {
	solarRoof: {
		temperature: [2, 3], // + 2-3 degrees (randomized in this range)
	},
	greenRoof: {
		airPollution: [-20, -30], // - 20-30% (randomized in this range)
		temperature: [-2, -3], // - 2-3 degrees (randomized in this range)
		treeCount: [5, 10], // + 5-10 trees (randomized in this range)
	},
	coolRoof: {
		airPollution: [-10, -20], // - 10-20% (randomized in this range)
		temperature: [-5, -7], // - 5-7 degrees (randomized in this range)
	},
	treeLinedStreets: {
		airPollution: [-10, -20], // - 10-20% (randomized in this range)
		temperature: [-3, -4], // - 3-4 degrees (randomized in this range)
		treeCount: [45, 55], // + 45-55 trees (randomized in this range)
		wildlife: {
			smallMammals: [20, 40], //  20-40 (randomized in this range)
			birds: [30, 50], // 30-50 (randomized in this range)
		},
	},
	natureCrossings: {
		wildlife: {
